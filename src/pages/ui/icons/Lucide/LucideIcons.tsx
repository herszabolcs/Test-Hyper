            ...
            <CardBody>
              <h4 className="header-title mb-2">
                ...
                <a href="https://lucide.dev/" target="_blank" className="ms-2 d-inline-flex align-items-center">
                  <span className="badge bg-primary align-middle">Docs <i className="mdi mdi-link font-12" /></span>
                </a>
              </h4>
              <p className="card-title-desc mb-2">Use <code>&lt;i data-lucide="accessibility"&gt;&lt;/i&gt;</code></p>
